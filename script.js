...
function drawBoard(brd) {
  var boardBorderColor = "#333";
  var boardInnerColor = "#fff";
  var triangleColor1 = "#bdbbad";
  var triangleColor2 = "#ece5d1";
  var triangleBorderColor = "#fff";
  var blackCheckerColor = "#333";
  var whiteCheckerColor = "#DDD";
  var cubeBodyColor = "#DDD";
  var cubeNumberColor = "#333";
  var buttonBackgroundColor = "#000000";
  var buttonBorderColor = "#333";
  var buttonTextColor = "#ddd";
